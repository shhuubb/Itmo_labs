...
\lstdefinestyle{mystyle}{
    ...
    language=SQL,
    morekeywords={BEGIN, SET, CREATE, TABLE, IF, NOT, EXISTS, PRIMARY, KEY, SERIAL, VARCHAR, INT, REFERENCES, TEXT, CHECK, INSERT, INTO, VALUES, SELECT, FROM, WHERE, AND, OR, NULL, DEFAULT, NOW, TIMESTAMPTZ, UNIQUE, SMALLINT}
}
